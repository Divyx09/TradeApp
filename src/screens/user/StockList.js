      ...
      >
        ...
        <Card.Actions>
          <Button
            ...
            mode='contained'
            onPress={() => {
              navigation.navigate("Buy", { stock: item });
            }}
          >
            Buy
          </Button>
